...
//
//        Billy.servoPrototype.setPosition(prm.deployServoMarker);
//        start = runtime.time();
//
...
//
//        Billy.servoPrototype.setPosition(0.7);// reach marker arm into crater to park
//
...
////
////                Billy.servoPrototype.setPosition(0.75);
////                start = runtime.time();
////
////                while (runtime.time() - start < 1) {
////                    telemetry.addLine("deploying marker");
...
////                }
////
////                Billy.servoPrototype.setPosition(0.1);
////
////                forwardPosition = (int) Math.round(-14 * prm.ROBOT_INCH_TO_MOTOR_DEG) * prm.DEGREES_TO_COUNTS;
