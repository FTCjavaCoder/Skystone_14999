...
*/
public class HardwareBillyTeleOp
{
...
//    public Servo    servoSampling    = null;
    ...
    public Servo    servoMineralBox = null;
...
//        servoSampling = hwMap.get(Servo.class, "sampling_servo");
        ...
        servoMineralBox  = hwMap.get(Servo.class, "mineral_box_servo");
