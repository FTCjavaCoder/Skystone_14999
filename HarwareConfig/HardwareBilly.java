...
//      public Servo  servoCapstoneRelease   = null;
    ...
    public void init(HardwareMap ahwMap, Constants cons) {
...
//        servoCapstoneRelease = hwMap.get(Servo.class, "capstone_servo");
    ...
    public void initMiniBot(HardwareMap ahwMap, Constants cons) {
        // Save reference to Hardware map
        hwMap = ahwMap;
    ...
    public void calcDistanceIMU(int[] driveDirection, BasicAuto om) {
        ...
        om.telemetry.addData("Robot Movement", "Incremental: (%.2f) Total: (%.2f)", incrementalDistance, distanceTraveled);
        om.telemetry.update();
